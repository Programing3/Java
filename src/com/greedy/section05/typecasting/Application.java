...
public class Application {
	...
	public static void main(String[] args) {
		...
		/* 테이터 형변환 */
		/* 데이터 형변환이 필요한 이유 
		 * 자바에서 다른 타입끼리의 연산은 피연산자들이 모두 같은 타입인 경우에만 실행할 수 있다.
...
//		int result1 = num1 + num2;		자동으로 큰 쪽 자료형인 long으로 변경 후 계산하기 때문에 int에 값을 담지 못한다.
		long result1 = num1 + num2;		//int + long은 서로 다른 자료형이라 데이터 손실이 발생하지 않는 int -> long 변환을 자동으로 수행하고 값을 담는다.
